        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <motion.div
              ...
              className="bg-gray-800/50 backdrop-blur-sm border border-[#00FFFF]/30 rounded-2xl p-6 shadow-[0_0_20px_#00BFFF] flex flex-col items-center justify-center text-center"
            >
              <a href="www.linkedin.com/in/lohith-sai-54b44437b" target="_blank" rel="noopener noreferrer" className="text-white font-bold py-4 px-4 transition-all duration-300 transform hover:scale-105">
              ...
              <p className="mt-2 text-sm">www.linkedin.com/in/lohith-sai-54b44437b</p>
            </motion.div>
          </div>
        </div>
      </div>
